...
One small trick: I asked my assistant to get the Mac to stay awake even with the lid closed. Because it runs locally, it has access to do all the necessary things. It downloaded [caffeinated](https://www.theapplegeek.co.uk/blog/caffeinate) and ran the relevant commands.
